...
class Plyr {
  constructor(target, options) {
    _defineProperty$1(this, "isSeeking", false);
    /**
     ...
     */
    _defineProperty$1(this, "forward", async seekTime => {
  ...
  set audioTrack(input) {
    ...
    const audioTrack = [!is.empty(input) && input, this.storage.get('audioTrack'), config.selected, config.default].find(e => e);
